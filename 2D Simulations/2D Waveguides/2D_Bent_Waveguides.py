...
def draw_circ(material,radius,x_pos,y_pos):
    a = 7
    b = sim_height - a - 1
    a = 7
    b = sim_width - a - 1
...
def bent_waveguide(wg_medium, bg_medium):
    draw_rect(bg_medium,250,250,0,0)
    draw_circ(wg_medium,36,125,75)
    draw_circ(bg_medium,23,125,75)
    draw_rect(bg_medium,41,80,85,36)
    draw_rect(bg_medium,80,41,86,35)
    draw_rect(wg_medium,126,13,0,98)
    draw_rect(wg_medium,13,76,148,0)

def bent_sq_waveguide(wg_medium, bg_medium):
    #draw_rect(bg_medium,250,250,0,0)
    draw_rect(wg_medium,148,13,0,137)
    draw_rect(wg_medium,13,113,148,137)
...
source2_x = settings.source2_x
source2_y = settings.source2_y
...
bent_waveguide('vacuum','dielectric')
bent_sq_waveguide('vacuum','dielectric')
